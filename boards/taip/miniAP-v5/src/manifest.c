...
static const px4_hw_mft_item_t hw_mft_list_v0511[] = {
	{
		//  PX4_MFT_PX4IO
		.present     = 0,
		.mandatory   = 0,
...
static px4_hw_mft_list_entry_t mft_lists[] = {
	{V5X11, hw_mft_list_v0511,        arraySize(hw_mft_list_v0511)},
	{V5X12, hw_mft_list_v0511,        arraySize(hw_mft_list_v0511)},
};
