...
//--------------------------------------------//---------------------------//----------------
//#define DMACHAN_SPI3_RX		DMAMAP_SPI3_RX_2	// DMA1, Stream 2, Channel 0    (OSD RX)
//#define DMACHAN_SPI3_TX		DMAMAP_SPI3_TX_2	// DMA1, Stream 7, Channel 0    (OSD TX)
// DMAMAP_USART3_RX	DMAMAP_USART3_RX	// DMA1, Stream 1, Channel 4    (TELEM2 RX)
#define DMAMAP_USART3_TX	DMAMAP_USART3_TX_1	// DMA1, Stream 3, Channel 4    (TELEM2 TX)
// DMAMAP_USART2_RX	DMAMAP_USART2_RX	// DMA1, Stream 5, Channel 4    (TELEM1 RX)
// DMAMAP_USART2_TX	DMAMAP_USART2_TX	// DMA1, Stream 6, Channel 4    (TELEM1 TX)

//  DMA2 Channel/Stream Selections
//--------------------------------------------//---------------------------//----------------
#define DMACHAN_SPI1_RX		DMAMAP_SPI1_RX_1	// DMA2, Stream 0, Channel 3    (IMU sensors RX)
#define DMACHAN_SPI1_TX    	DMAMAP_SPI1_TX_1	// DMA2, Stream 3, Channel 3	(IMU sensors TX)
#define DMAMAP_SDIO      	DMAMAP_SDIO_2		// DMA2, Stream 6, Channel 4	(SDCARD)
#define DMAMAP_USART6_RX	DMAMAP_USART6_RX_1	// DMA2, Stream 1, Channel 5	(GPS RX)
#define DMAMAP_USART6_TX	DMAMAP_USART6_TX_2	// DMA2, Stream 7, Channel 5	(GPS TX)
// DMAMAP_TIM1_UP	DMAMAP_TIM1_UP		// DMA2, Stream 5, Channel 6	(DSHOT)
